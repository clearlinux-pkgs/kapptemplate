...
Version  : 23.08.2
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.08.2/src/kapptemplate-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kapptemplate-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kapptemplate-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kapptemplate-23.08.2
cd %{_builddir}/kapptemplate-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697253186
mkdir -p clr-build
pushd clr-build
