...
Version  : 21.12.0
Release  : 34
URL      : https://download.kde.org/stable/release-service/21.12.0/src/kapptemplate-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kapptemplate-21.12.0.tar.xz
...
%prep
%setup -q -n kapptemplate-21.12.0
cd %{_builddir}/kapptemplate-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639627425
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kapptemplate-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kapptemplate/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kapptemplate-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kapptemplate/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5-simple/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kapptemplate/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5-simple/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kapptemplate/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5-simple/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kapptemplate/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5-simple/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kapptemplate/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kapptemplate/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kapptemplate/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kapptemplate/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kapptemplate/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kapptemplate-21.12.0/src/templates/C++/kde-frameworks5/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kapptemplate/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
