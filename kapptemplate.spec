...
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kapptemplate-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kapptemplate-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kapptemplate-19.12.2
cd %{_builddir}/kapptemplate-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581014696
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kapptemplate-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kapptemplate/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kapptemplate-19.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kapptemplate/fcbf818f92ef8679a88f3778b12b4c8b5810545b
cp %{_builddir}/kapptemplate-19.12.2/src/templates/C++/kde-frameworks5/COPYING %{buildroot}/usr/share/package-licenses/kapptemplate/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kapptemplate-19.12.2/src/templates/C++/kde-frameworks5/COPYING.DOC %{buildroot}/usr/share/package-licenses/kapptemplate/fcbf818f92ef8679a88f3778b12b4c8b5810545b
pushd clr-build
%make_install
popd
