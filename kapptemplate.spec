...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kapptemplate-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kapptemplate-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kapptemplate-23.04.0
cd %{_builddir}/kapptemplate-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682030934
mkdir -p clr-build
pushd clr-build
